...
- A breakdown of the attack chain in plain language
- MITRE ATT&CK technique mappings
- Preventive controls framed around risk and GRC principles
- My personal takeaways as someone bringing a compliance and risk lens to this field
---
## Background
...
|-------|------|-------------|
| [Claude Code GitHub Actions Supply Chain Vulnerability](./claude-code-github-actions-supply-chain.md) | June 2026 | Supply chain attack, prompt injection, permission misconfiguration, vendor risk |
---
